<?php /* Template Name: Sollicitatie */ ?>
<?php get_header(); ?>
<div class="main">
         ...
         <div class="panel panel-default">
             <div class="panel-heading active">
                 <h4 class="panel-title">
                     <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne"><?php the_field('sollicitatie_accordion_1_title'); ?></a>
                 </h4>
             </div>
             <div id="collapseOne" class="panel-collapse collapse in">
               <div class="panel-body">
                   <p><?php the_field('sollicitatie_accordion_1_text_field'); ?>
                  </p>
                  <a href="#" class="cta--primary"><?php the_field('sollicitatie_accordion_1_button'); ?></a>
               </div>
             </div>
         </div>
         <div class="panel panel-default">
             <div class="panel-heading">
                 <h4 class="panel-title">
                     <a data-toggle="collapse" data-parent="#accordion" href="#collapseTwo"><?php the_field('sollicitatie_accordion_2_title'); ?></a>
                 </h4>
             </div>
             <div id="collapseTwo" class="panel-collapse collapse">
               <div class="panel-body">
                   <p><?php the_field('sollicitatie_accordion_2_text_field'); ?>
                  </p>
                  <a href="#" class="cta--primary"><?php the_field('sollicitatie_accordion_2_button'); ?></a>
               </div>
             </div>
         </div>
         <div class="panel panel-default">
             <div class="panel-heading">
                 <h4 class="panel-title">
                     <a data-toggle="collapse" data-parent="#accordion" href="#collapseThree"><?php the_field('sollicitatie_accordion_3_title'); ?></a>
                 </h4>
             </div>
             <div id="collapseThree" class="panel-collapse collapse">
               <div class="panel-body">
                   <p><?php the_field('sollicitatie_accordion_3_text_field'); ?>
                  </p>
                  <a href="#" class="cta--primary"><?php the_field('sollicitatie_accordion_3_button'); ?></a>
               </div>
             </div>
             </div>
         </div>
